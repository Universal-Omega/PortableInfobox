...
- `$wgPortableInfoboxUseHeadings` (bool) - use heading tags for infobox titles and group headers, it may cause incompatibilities with other extensions as well as Parsoid, for that reason setting this to true is deprecated and this config may eventually be removed. It previously defaulted to true. (default: false)
